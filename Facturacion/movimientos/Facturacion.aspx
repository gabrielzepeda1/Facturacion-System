<%@ Page Title="" Language="VB" MasterPageFile="~/master/prinFactura.master" AutoEventWireup="false" CodeFile="Facturacion.aspx.vb" Inherits="movimientos_Factura"
    ...
    <asp:ScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="main-container">
            ...
            <div class="form-container-3">
                <div>
                    ...
                    <asp:DropDownList ID="ddlCliente" runat="server" CssClass="select select2" AutoPostBack="true" ></asp:DropDownList>
                </div>

                <div>
                    <label for="cliente-eventual">Cliente Eventual</label>
                    <asp:TextBox ID="TextNombreCliente" runat="server" MaxLength="50" CssClass="text" onchange="ClienEventLosFocu(this)" AutoPostBack="true" ></asp:TextBox>
                </div>
            </div> <!-- FORM-CONTAINER-3 -->

                  <div id="form-container-4">
                    <div>
                        <div>
                            <label for="txtNoFactura">Número de Factura:</label>
                            <asp:TextBox ID="txtNoFactura" runat="server" Enabled="false"></asp:TextBox>
                        </div>
                        <div>
                            <label for="ID">Cédula del Cliente</label>
                            <asp:TextBox ID="TextId" runat="server" CssClass ="placeholder" Text ="" AutoPostBack="true" ></asp:TextBox>
                        </div>
                    </div>
        ...
        <asp:UpdatePanel ID="upDatosFactura" runat="server" UpdateMode="Conditional" class="grid-container-2">
          <ContentTemplate>
                ...
                <div id="nombreDelVendedor">
                    <label for="vendedor">Vendedor:</label>
                    <asp:DropDownList ID="ddlVendedor" runat="server" CssClass=" select2"></asp:DropDownList>
                </div>

                <div id="nombreDelProducto">
                    <label for="producto">Producto:</label>
                    <asp:DropDownList ID="ddlProducto" runat="server" CssClass="select2" AutoPostBack="true"></asp:DropDownList>
                </div>

                <div class="number">
                    <label for="cantidad">Cantidad:</label>
                    <asp:TextBox ID="TextCantidad" runat="server"   CssClass="number" Text="0" onkeypress="formatNumber(this, 2)"> </asp:TextBox>
                </div>

                <div class="number">
                    <label for="bultos">Bultos:</label>
                    <asp:TextBox ID="TextBultos" runat="server" CssClass="number" Text="0" onkeypress="formatNumber(this, 2)" > </asp:TextBox>
                </div>

                <div class="number">
                    <label for ="% Desc">% Desc.</label>
                    <asp:TextBox ID="TextPorDesc" runat="server" CssClass="text" Text="0" AutoPostBack="true"></asp:TextBox>
                </div>


                <div class="number">
                    <label for="precio">Precio:</label>
                    <asp:TextBox ID="TextPrecio" runat="server" CssClass="text" Text="0.00" AutoPostBack="true" ReadOnly="true"></asp:TextBox>
                </div>
        ...
        <ContentTemplate>
            ...
            <div class="grid-container-3 ">
                ...
                <div>
                    ...
                    <asp:TextBox ID="TextTotalLibras" runat="server" Text="0.00"
                        onkeypress="formatNumber(this,2)" Enabled="false" AutoPostBack="true"></asp:TextBox>
                </div>

                <div>
                    <label>Subtotal</label>
                    <asp:textbox ID="TextSubtotal" runat="server" Text="0.00" onkeypress="formatNumber(this,2)"   Enabled="false" CssClass="number-format"></asp:textbox>
                </div>


                <div>
                    <label>Valor Desc.</label>
                    <asp:TextBox ID="TextValorDesc" runat="server" Enabled="false" Text="0.00" onkeypress="formatNumber(this,2)" AutoPostBack="true"></asp:TextBox>
                </div>
                ...
                <div>
                    <label>Neto C$</label>
                    <asp:TextBox ID="TextNeto" runat="server" Enabled="false"></asp:TextBox>
                </div>

                <div>
                    <label>Neto $</label>
                    <asp:TextBox ID="TextNetoDolar" runat="server" Enabled="false"></asp:TextBox>
                </div>
            ...
            <asp:UpdatePanel runat="server" ID="upDatosComp" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="center-color">
                        <h2><asp:Label ID="LblResp" runat="server" AutoPostBack="true"></asp:Label></h2>
                    </div>
