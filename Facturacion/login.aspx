...
<body class="bg-dark">
    <form runat="server">
        ...
        <div class="container d-flex flex-column justify-content-center align-items-center" style="height: 100vh;">
            ...
            <div class="my-1">
                <asp:TextBox ID="txtUsuario" CssClass="form-control" runat="server" ClientIDMode="AutoID" AutoCompleteType="None"></asp:TextBox>
                <label>Usuario: </label>
            </div>
            <div class="my-1">
                <asp:TextBox ID="txtPass" CssClass="form-control" runat="server" TextMode="Password" ClientIDMode="AutoID" AutoCompleteType="None"></asp:TextBox>
