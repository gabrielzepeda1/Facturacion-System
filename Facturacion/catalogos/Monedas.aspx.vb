...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_monedas @opcion=3," & _
                  "@codigoPais =  " & vCPais & " ," & _
                  "@codigoMoneda =  0  ," & _
                  "@simboloMoneda = 0  ," & _
                  "@descripcion = 0  ," & _
...
#End Region
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_monedas @opcion=1," & _
                   "@codigoPais =  " & Me.ddlPais.SelectedValue & " ," & _
                   "@codigoMoneda =  " & Me.TextCodigo.Text.Trim & " ," & _
                   "@simboloMoneda =  '" & Me.TextSimbolo.Text.Trim & "' ," & _
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_monedas @opcion=2," & _
                  "@codigoPais =  " & vPais & " ," & _
                  "@codigoMoneda =  " & Me.hdfCodigo.Value & " ," & _
                  "@simboloMoneda = '0'," & _
                  "@descripcion = '0'," & _
                  "@BUSQUEDAD = '0'  "
    ...
    Private Sub Actualizar(Codigo As Integer, Descripcion As String, simbolo As String, Pais As Integer)
        ...
        Try
            ...
            sql &= "EXEC Cat_monedas @opcion=1," & _
                  "@codigoPais =  " & Pais & " ," & _
                  "@codigoMoneda =  " & Codigo & " ," & _
                  "@simboloMoneda =  " & simbolo & " ," & _
