...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_Paises @opcion=3," & _
                  "@codigo =  NULL  ," & _
                  "@descripcion =  NULL  ," & _
                  "@codusuario =  NULL ," & _
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_Paises @opcion=1," & _
                   "@codigo =  NULL  ," & _
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Paises  @opcion=2," & _
...
#Region "EXPORTAR DATOS A EXCELL"
    ...
    Protected Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Try
            ...
            Dim name_doc = "catalogo_Pais" & Date.Now.Year & Date.Now.Month & Date.Now.Day
            ...
            MyHTML &= "<h2>Catalogo de Paises <br/> al dia " & Date.Now.Day & "/" & Date.Now.Month & "/" & Date.Now.Year & "</h2>"
