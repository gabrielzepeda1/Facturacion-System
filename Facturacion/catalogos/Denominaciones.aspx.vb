...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_Denominacion @opcion=3," & _
                  "@codigoDenominacion =  NULL  ," & _
                  "@codigoPais =  " & vCPais & " ," & _
                  "@codigoMoneda =  NULL  ," & _
                  "@denominacion =  NULL  ," & _
                  "@descripcion =  NULL ," & _
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_Denominacion @opcion=1," & _
                   "@codigoDenominacion =  " & Me.txtCodigo.Text.Trim & " ," & _
                   "@codigoPais =  " & Me.ddlPais.SelectedValue & " ," & _
                   "@codigoMoneda =  " & Me.ddlMoneda.SelectedValue & " ," & _
                   "@denominacion =  " & Me.TextDenominacion.Text.Trim & " ," & _
                   "@descripcion = '" & Me.TextDescripcion.Text.Trim & "' ," & _
                   "@BUSQUEDAD = '0'  "
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Denominacion @opcion=2," & _
                  "@codigoDenominacion =  " & Me.hdfCodigo.Value & " ," & _
                  "@codigoPais =  '0'," & _
                  "@codigoMoneda = '0'," & _
                  "@denominacion = '0'," & _
                  "@descripcion = '0'," & _
    ...
    Private Sub Actualizar(codigo As Integer, Descripcion As String, denominacion As String, CodigoPais As Integer, CodigoMoneda As Integer)
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Denominacion @opcion=1," & _
                  "@codigoDenominacion =  " & codigo & " ," & _
                  "@codigoPais =  " & CodigoPais & " ," & _
                  "@codigoMoneda =  " & CodigoMoneda & " ," & _
                  "@denominacion =  " & denominacion & " ," & _
...
#Region "Editar en formulario popup"
    ...
    Private Sub GetReg()
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Denominacion @opcion=4," & _
                  "@codigoDenominacion =  " & Me.hdfCodigo.Value & " ," & _
                  "@codigoPais =  '0'," & _
                  "@codigoMoneda = '0'," & _
                  "@denominacion = '0'," & _
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" & _
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("denominacion").ToString.Trim & "</td>" & _
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("Pais").ToString.Trim & "</td>" & _
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("moneda").ToString.Trim & "</td>" & _
                              "<td></td>" & _
                              "</tr>"
