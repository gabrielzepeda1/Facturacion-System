...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_ComisVendedores @opcion=3," & _
                  "@codigoPais =  " & vCPais & " ," & _
                  "@codigoEmp =  0  ," & _
                  "@codigoPuesto = 0  ," & _
                  "@codigoFamilia = 0  ," & _
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_ComisVendedores @opcion=1," & _
                   "@codigoPais =  " & Me.ddlPais.SelectedValue & " ," & _
                   "@codigoEmp =  " & Me.ddlEmpresa.SelectedValue & " ," & _
                   "@codigoPuesto =  '" & Me.ddlPuesto.SelectedValue & "' ," & _
                   "@codigoFamilia =  " & Me.ddlFamilia.SelectedValue & " ," & _
                   "@codigoVendedor =  " & Me.ddlVendedor.SelectedValue & " ," & _
                   "@comision =  " & Me.TextComision.Text.Trim & " ," & _
                   "@Activo =  '" & IIf(Me.CheckActivo.Checked = True, 1, 0) & "' ," & _
                   "@BUSQUEDAD = '" & BUSQUEDAD & "' "
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_ComisVendedores @opcion=2," & _
                  "@codigoPais =  " & vPais & " ," & _
                  "@codigoEmp =  " & vEmpresa & " ," & _
                  "@codigoPuesto =  '" & vPuesto & "' ," & _
                  "@codigoFamilia =  " & vFamilia & " ," & _
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" & _
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("Comision").ToString.Trim & "</td>" & _
