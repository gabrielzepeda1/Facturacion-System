...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_FormaPago @opcion=3," & _
                  "@codigoPais = " & vCPais & " ," & _
                  "@codigoEmpresa =  NULL  ," & _
                  "@codigoPuesto =  NULL  ," & _
                  "@codigoFormaPago =  NULL  ," & _
                  "@descripcion =  NULL ," & _
                  "@BUSQUEDAD = '" & BUSQUEDAD & "', " & _
                  "@PorDefecto = 1 "
...
#End Region
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_FormaPago @opcion=1," & _
                   ...
                   "@codigoFormaPago =  '" & Me.TextCodigo.Text.Trim & "' ," & _
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_FormaPago @opcion=2," & _
                  "@codigoPais =  '0'," & _
                  "@codigoEmpresa = '0'," & _
                  "@codigoPuesto = '0'," & _
                  "@codigoFormaPago =  '" & Me.hdfCodigo.Value & "' ," & _
                  "@descripcion = '0'," & _
                  "@BUSQUEDAD = '0'  ," & _
                  "@PorDefecto = 0 "
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" & _
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("PorDefecto").ToString.Trim & "</td>" & _
                              "<td></td>" & _
                              "</tr>"
