...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_ProductosXPais @opcion=3," &
                  "@codPais =  " & vCPais & " ," &
                  "@codigoProducto =  '0'  ," &
                  "@codUndMedida = 0  ," &
                  "@descripcion = '0'  ," &
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_ProductosXPais @opcion=2," &
                  "@codPais =  " & vPais & " ," &
                  "@codigoProducto =  " & Me.hdfCodigo.Value & " ," &
                  "@codUndMedida =  0 ," &
                  "@descripcion =  '" & Session("Descrip") & "' ," &
                  "@descripImpr =  '' ," &
                  "@numProducto =  '" & Session("numero") & "' ," &
                  "@activo = 0 ," &
                  "@ExcentoImp = 0 ," &
                  "@codEmpresa =  " & Request.Cookies("CKSMFACTURA")("CodEmpresa") & " ," &
    ...
    Private Sub Actualizar(Codigo As String, Descripcion As String, deImpre As String, Numero As Integer, VUnidad As Integer, Impt As Boolean, Vac As Boolean)
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_ProductosXPais @opcion=1," &
                   "@codPais =  " & Request.Cookies("CKSMFACTURA")("codPais") & " ," &
                   "@codigoProducto =  '" & Codigo & "' ," &
                   "@codUndMedida =  " & VUnidad & " ," &
        ...
        Try
            ...
            If Not dtTabla Is Nothing Then
                MyHTML &= "<table cellspacing=""0"" cellpadding=""0"">" &
                          ...
                          "<th></th>" &
                          "<th>Codigo</th>" &
                          "<th>Descripcion Maestro</th>" &
                          "<th>Descripcion Imprimir</th>" &
                          "<th>Pais</th>" &
                          "<th>UnidadMedida</th>" &
                          "<th>excento_imp</th>" &
                          "<th>activo</th>" &
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" &
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("DescripImpresion").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("Pais").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("UnidadMedida").ToString.Trim & "</td>" &
