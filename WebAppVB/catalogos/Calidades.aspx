<%@ Page Title="Catálogo de Calidades | Facturación" Language="VB" EnableEventValidation="false" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_Calidades" Codebehind="Calidades.aspx.vb" %>

<%@ Register Src="~/usercontrol/menu_catalogos.ascx" TagPrefix="uc1" TagName="menu_catalogos" %>
<%--<%@ Register src="../UserControl/Controles.ascx" tagname="Controles" tagprefix="uc2" %>--%>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpTitulo" runat="Server">
    <h1>Catálogo de Calidades</h1>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
        ...
        <div id="main-form-content">
            ...
            <div id="main-form-content-field">
                ...
                <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional">
                    ...
                    <Triggers>
                        <%--<asp:AsyncPostBackTrigger ControlID="btnButtons" EventName="ClickActualizar"/>
                        <asp:AsyncPostBackTrigger ControlID="btnButtons" EventName="ClickNuevo"/>--%>
                        <asp:AsyncPostBackTrigger ControlID="BtnGuardar" EventName="Click" />
    ...
    <div id="popup-form" class="white-popup-block mfp-hide">
        <div class="bstt-form PantallaPopUp">
            ...
            <h2 class="center-color">Agregar/Editar Calidad del Producto</h2>
