...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_ProductosMaestro @opcion=3," &
                  "@codigo =  0  ," &
                  "@numproducto =  0  ," &
                  "@descripcion = 0  ," &
                  "@sigla = 0  ," &
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_ProductosMaestro @opcion=1," &
                   "@codigo =  " & Me.TextCodProducto.Text.Trim & " ," &
                   "@numproducto =  " & Me.txtNumProd.Text.Trim & " ," &
                   "@descripcion =  '" & Me.txtDescripcion.Text.Trim & "' ," &
                   "@SIGLA =  " & Me.ddlSigla.SelectedValue & " ," &
                   "@codorigen =  " & Me.ddlOrigen.SelectedValue & " ," &
                   "@codcalidad =  " & Me.ddlCalidad.SelectedValue & " ," &
                   "@codpresentacion =  " & Me.ddlPresentacion.SelectedValue & " ," &
                   "@codfamilia =  " & Me.ddlFamilia.SelectedValue & " ," &
...
#Region "Editar en formulario popup"
    ...
    Private Sub GetReg()
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_ProductosMaestro @opcion=4," &
                   "@codigo =  " & Me.hdfCodigo.Value & "," &
                   "@numproducto =  0," &
                   "@descripcion =  '0' ," &
                   "@SIGLA =  '0'," &
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" &
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("num_producto").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("producto").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("sigla").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("origen").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("calidad").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("presentacion").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("familia").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("produccion_sm").ToString.Trim & "</td>" &
                             "<td></td>" &
                              "</tr>"
