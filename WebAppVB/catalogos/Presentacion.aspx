<%@ Page Title="" Language="VB" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_Presentacion" Codebehind="Presentacion.aspx.vb" %>
    ...
    <div id="main-form">
        ...
        <div id="popup-form" class="white-popup-block mfp-hide">
            <div class="bstt-form PantallaPopUp">
                ...
                <h2 class="center-color">Agregar Presentación del Producto</h2>

                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <label class="vlabel">Descripcion de Presentacion del producto</label>
        ...
        $(document).ready(function () {
            ...
            $("#btnNew").click(function () {
                ...
                $("#<%=hdfCodigo.ClientID%>").val("");
                 ...
                 $("#popuptittle").text('Agregar Presentación del Producto');
