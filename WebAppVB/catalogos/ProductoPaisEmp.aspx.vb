...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_ProductosXPais @opcion=4," &
                  "@codPais =  0  ," &
                  "@codigoProducto =  '0'  ," &
                  "@codUndMedida = 0  ," &
                  "@descripcion = '0'  ," &
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            sql &= "EXEC Cat_ProductosXPais @opcion=1," &
                   ...
                   "@codigoProducto = '" & Session("Codigo") & "' ," &
                   "@codUndMedida =  " & Me.ddlUnidadMed.SelectedValue & " ," &
                   "@descripcion =  '" & Session("Descrip") & "' ," &
                   "@descripImpr =  '" & Me.TextDecImpri.Text.Trim & "' ," &
                   "@numProducto =  '" & Session("Numero") & "' ," &
                   "@activo = '" & IIf(Me.CheckAt.Checked = True, 1, 0) & "' ," &
                   "@ExcentoImp = '" & IIf(Me.CheckImtos.Checked = True, 1, 0) & "' ," &
                   "@codEmpresa =  " & Request.Cookies("CKSMFACTURA")("CodEmpresa") & " ," &
