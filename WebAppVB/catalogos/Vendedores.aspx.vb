...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    ...
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_Vendedores @opcion=3," &
                  "@codigoPais =   " & vCPais & " ," &
                  "@codigoEmp =  0  ," &
                  "@codigoPuesto = 0  ," &
                  "@nombre = 0  ," &
...
#Region "Editar en formulario popup"
    ...
    Private Sub GetReg()
        Try
            ...
            sql &= "EXEC Cat_Vendedores @opcion=4," &
                   "@codigoPais =  0 ," &
                   "@codigoEmp =  0 ," &
                   "@codigoPuesto = 0 ," &
                   "@nombre =  '0' ," &
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Vendedores @opcion=1," &
                   ...
                   "@Apellido =  '" & Me.txtApellidos.Text.Trim & "' ," &
                   "@codusuario =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                   "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                   "@codigoVendedor =  " & Me.TextCodigo.Text.Trim & " ," &
                   "@ctaContable =  '" & Me.Textctacontable.Text.Trim & "' ," &
                   "@BUSQUEDAD = '0'  "
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Vendedores @opcion=2," &
                   "@codigoPais =  0 ," &
                   "@codigoEmp =  0 ," &
                   "@codigoPuesto =  0 ," &
                   "@nombre =  '0' ," &
