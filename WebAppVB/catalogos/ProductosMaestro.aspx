<%@ Page Title="Productos Maestros | Facturación" Language="VB" EnableEventValidation="false" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_ProductosMaestro" Codebehind="ProductosMaestro.aspx.vb" %>
                                ...
                                <asp:GridView
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Prod EN SN">
                                            <EditItemTemplate>
                                                <asp:CheckBox ID="CheckSm" runat="server" AutoPostBack="True"></asp:CheckBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
