...
#Region "PROCESOS Y EVENTOS DEL GRIDVIEW"
    Private Sub Load_GridView()
        Try
            ...
            SQL &= "EXEC Cat_CalidadesProductos @opcion=3," &
                  "@codigo =  NULL  ," &
                  "@descripcion =  NULL  ," &
                  "@codusuario =  NULL ," &
                  "@codusuarioUlt =  NULL  ," &
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            If Me.hdfCodigo.Value.Trim = String.Empty Then
                vcodigo = "0"
            Else
                vcodigo = Me.hdfCodigo.Value.Trim
            End If

            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_CalidadesProductos @opcion=1," &
                   "@codigo =  " & vcodigo & " ," &
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_CalidadesProductos  @opcion=2," &
...
#Region "EXPORTAR DATOS A EXCELL"
    ...
    Protected Sub btnExportar_Click(sender As Object, e As EventArgs) Handles btnExportar.Click
        Try
            ...
            MyHTML &= "<h2>Catalogo de origenes <br/> al dia " & Date.Now.Day & "/" & Date.Now.Month & "/" & Date.Now.Year & "</h2>"
...
#End Region
    ...
    Private Sub GetRegClientes()
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_CalidadesProductos @opcion=4," &
                  "@codigo =  " & Me.hdfCodigo.Value & "," &
                  "@descripcion =  '0' ," &
                  "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
