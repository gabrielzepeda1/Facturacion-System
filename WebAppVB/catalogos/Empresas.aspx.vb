...
#Region "Editar en formulario popup"
    ...
    Private Sub GetReg()
        Try
            ...
            sql &= "EXEC Cat_Empresas @opcion=4," &
                 "@codPais =  0 ," &
...
#Region "ENVIAR INFORMACIÓN HACIA LA BASE DE DATOS"
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Empresas @opcion=1," &
                   "@codPais =  " & Me.ddlPais.SelectedValue & " ," &
                   "@codigo =  " & Me.txtCodigo.Text.Trim & " ," &
                   "@descripcion =  '" & Me.TextEmpresa.Text.Trim & "' ," &
                   "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                   "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                   "@NombImtos = '" & Me.TextImpuesto.Text.Trim & "' ," &
                   "@PorcImtos = " & Me.TextPorcImpuesto.Text.Trim & " ," &
                   "@DescripCorta = '" & Me.TextDescripCorta.Text.Trim & "' ," &
                   "@CeduRuc = '" & Me.TextCedulaRuc.Text.Trim & "' ," &
                   "@Direccion = '" & Me.TextDireccion.Text.Trim & "' ," &
                   "@AutoMifin = '" & Me.TextAutorizMifin.Text.Trim & "' ," &
                   "@BUSQUEDAD = '0' "
    ...
    Private Sub Eliminar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_Empresas @opcion=2," &
                  "@codPais =  0 ," &
                  "@codigo =  " & Me.hdfCodigo.Value & " ," &
                  "@descripcion =  0 ," &
                  "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
    ...
    Private Sub Actualizar(Pais As Integer, Codigo As String, DescriEmpresa As String, Impuesto As String, PorcImpuesto As Double, DescripCorta As String, CedulaRuc As String, Direccion As String, AutorizMifin As String)
        ...
        Try
            ...
            sql &= "EXEC Cat_Empresas @opcion=1," &
                  "@codPais =  '" & Pais & "' ," &
                  "@codigo =  " & Codigo & " ," &
                  "@descripcion =  '" & DescriEmpresa & "' ," &
                  "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@NombImtos = '" & Impuesto & "' ," &
                  "@PorcImtos = " & PorcImpuesto & " ," &
                  "@DescripCorta = '" & DescripCorta & "' ," &
                  "@CeduRuc = '" & CedulaRuc & "' ," &
                  "@Direccion = '" & Direccion & "' ," &
                  "@AutoMifin =  '" & AutorizMifin & "' ," &
                  "@BUSQUEDAD = '" & BUSQUEDAD & "' "
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" &
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("COD_PAIS").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("Pais").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("Impuesto").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("porc_impuesto").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("descripcion_corta").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("cedula_ruc").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("direccion").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("autorizacion_mifin").ToString.Trim & "</td>" &
