<%@ Page Title="" Language="VB" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_familia" Codebehind="Familia.aspx.vb" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div id="popup-form" class="white-popup-block mfp-hide">
        <div class="bstt-form PantallaPopUp">
            ...
            <h2 class="center-color">Agregar Familia del Producto</h2>
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <label class="vlabel">Descripcion de Familia de producto</label>
