...
#Region "Editar en formulario popup"
    ...
    Private Sub GetReg()
        Try
            ...
            sql &= "EXEC Cat_puesto @opcion=4," &
                 "@codPuesto =  " & Me.hdfCodigo.Value & "," &
                 "@codEmpresa =  0  ," &
                 "@codPais = 0  ," &
                 "@descripcion =  0  ," &
                 "@noNotaDebito =  0  ," &
...
#End Region
    ...
    Private Sub Guardar()
        ...
        Try
            ...
            Dim sql As String = "SET DATEFORMAT DMY " & vbCrLf
            sql &= "EXEC Cat_puesto @opcion=1," &
                   "@codPuesto =  " & Me.txtCodigo.Text.Trim & " ," &
                  "@codEmpresa =  " & Me.ddlEmpresa.SelectedValue & " ," &
                  "@codPais =  " & Me.ddlPais.SelectedValue & " ," &
                  "@descripcion =  '" & Me.TextPuesto.Text.Trim & "' ," &
                  "@noNotaDebito =  " & Me.TextNoDebito.Text.Trim & " ," &
                  "@noNotaCredito =  " & Me.TextNoCredito.Text.Trim & " ," &
                  "@noRecibo =  " & Me.TextNoRecibo.Text.Trim & " ," &
                  "@noFactura =  " & Me.TextFactura.Text.Trim & " ," &
                  "@noCreditoRet =  " & Me.TextNoCredRetenc.Text.Trim & " ," &
                  "@formatoImpresion =  '" & Me.TextFormatoImp.Text.Trim & "' ," &
                  "@lineasImprimir =  " & Me.TextLineImpri.Text.Trim & " ," &
                  "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@NoCuotasPlanillas =  " & Me.TextCuotaPla.Text.Trim & " ," &
                  "@VerifInventario =  " & IIf(Me.CheckVeInv.Checked = True, 1, 0) & " ," &
                  "@telefono =  '" & Me.TextTelefono.Text.Trim & "' ," &
                  "@descripCorta =  '" & Me.TextDescCorta.Text.Trim & "' ," &
                  "@BUSQUEDAD = '0'  "
    ...
    Private Sub Actualizar(Empresa As Integer, Pais As Integer, Codigo As String, DescriPuesto As String, debito As Integer, credito As Integer,
        ...
        Try
            ...
            sql &= "EXEC Cat_puesto @opcion=1," &
                  ...
                  "@codEmpresa =  " & Empresa & " ," &
                  "@codPais =  " & Pais & " ," &
                  "@descripcion =  '" & DescriPuesto & "' ," &
                  "@noNotaDebito =  " & debito & " ," &
                  "@noNotaCredito =  " & credito & " ," &
                  "@noRecibo =  " & recibo & " ," &
                  "@noFactura =  " & factura & " ," &
                  "@noCreditoRet =  " & credRtenc & " ," &
                  "@formatoImpresion =  '" & ForIMpre & "' ," &
                  "@lineasImprimir =  " & LineIm & " ," &
                  "@codusuario =   " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@codusuarioUlt =  " & Request.Cookies("CKSMFACTURA")("cod_usuario") & " ," &
                  "@NoCuotasPlanillas =  " & CuotPlan & " ," &
                  "@VerifInventario =  " & inv & " ," &
                  "@telefono =  '" & telf & "' ," &
                  "@descripCorta =  '" & desCo & "' ," &
                  "@BUSQUEDAD = '0'  "
            ...
            If Not dtTabla Is Nothing Then
                ...
                For i As Integer = 0 To dtTabla.Rows.Count - 1
                    MyHTML &= "<tr" & clase & ">" &
                              ...
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoNotaDebito").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoNotaCredito").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoRecibo").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoFactura").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoNotaCredRetencion").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("FormatoImpresion").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("LineasImprimir").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("NoCuotasenPlan").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("VerifInventario").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("telefono").ToString.Trim & "</td>" &
                              "<td class=""ml"">" & dtTabla.Rows(i).Item("DesCorta").ToString.Trim & "</td>" &
