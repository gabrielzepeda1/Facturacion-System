<%@ Page Title="Catalogo de Forma de Pago | Facturación" Language="VB" EnableEventValidation="false" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_FomaPago" Codebehind="FomaPago.aspx.vb" %>
