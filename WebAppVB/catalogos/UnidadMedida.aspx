<%@ Page Title="" Language="VB" MasterPageFile="~/master/principal.master" AutoEventWireup="false" Inherits="WebAppVB.catalogos_UnidadMedida" Codebehind="UnidadMedida.aspx.vb" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <div id="popup-form" class="white-popup-block mfp-hide">
        <div class="bstt-form">
            ...
            <h2 class="center-color">Agregar Unidad de Medidas</h2>
