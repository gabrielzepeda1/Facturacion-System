CREATE TABLE [dbo].[factura_Tmp] (
    ...
    [Neto]                    DECIMAL (12, 2) CONSTRAINT [DF_factura_Tmp_Neto] DEFAULT ((0)) NULL,
    [Externo]                 BIT             NULL,
    ...
    CONSTRAINT [PK_factura_Tmp] PRIMARY KEY CLUSTERED ([cod_pais] ASC, [cod_empresa] ASC, [cod_puesto] ASC, [no_factura] ASC, [fecha] ASC, [cod_producto] ASC)
);
